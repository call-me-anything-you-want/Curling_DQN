...
def calculate_loss(training_net, train_data, gamma = 1.0):
    ...
    next_q_value = training_net(train_data["new_observation"]).detach()
...
if __name__ == "__main__":
    ...
    save(q_net, all_losses, all_rewards, f"./dqn_{reward_type}")
